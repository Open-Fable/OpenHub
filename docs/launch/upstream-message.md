# Messages to Upstream Maintainers

Send these as GitHub Discussions/Issues or DMs after the launch, not before.
Tone: informative, respectful, no ask for promotion.
...
- Send AFTER launch, not before — you want something to show
- Don't ask for retweets or promotion
- Be prepared for them to ask you to change the name, add attribution, etc.
- If they respond positively, ask if they'd be open to linking from their README
