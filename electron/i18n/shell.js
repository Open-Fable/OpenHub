...
(function () {
  ...
  window.I18N.register({
    fr: {
      ...
      "cfg.keys.custom.addTitle": "Ajouter un fournisseur",
      "cfg.keys.custom.addBtn": "Ajouter",
      "cfg.keys.custom.groupTitle": "Fournisseurs Personnalisés",
      "cfg.keys.custom.namePlaceholder": "Nom (ex: Groq, Together)",
      "cfg.keys.custom.urlPlaceholder":
        "URL de base (ex: https://api.groq.com/openai/v1)",
      "cfg.keys.custom.keyPlaceholder": "Clé d'API",
      "cfg.keys.custom.modelsPlaceholder":
        "Modèles (séparés par des virgules, ex: llama3-8b-8192)",
    ...
    en: {
      ...
      "cfg.keys.custom.addTitle": "Add a provider",
      "cfg.keys.custom.addBtn": "Add",
      "cfg.keys.custom.groupTitle": "Custom Providers",
      "cfg.keys.custom.namePlaceholder": "Name (e.g. Groq, Together)",
      "cfg.keys.custom.urlPlaceholder": "Base URL (e.g. https://api.groq.com/openai/v1)",
      "cfg.keys.custom.keyPlaceholder": "API key",
      "cfg.keys.custom.modelsPlaceholder":
        "Models (comma-separated, e.g. llama3-8b-8192)",
